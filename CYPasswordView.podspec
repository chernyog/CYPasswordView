...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "cheny"
  # s.authors            = { "cheny" => "yong.chen@jimubox.com" }
  # s.social_media_url   = "http://twitter.com/cheny"
  ...
  s.source       = { :git => "https://github.com/chernyog/CYPasswordView.git", :tag => s.version }
